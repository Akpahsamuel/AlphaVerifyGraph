import {
  ...
  CertificationApproved as CertificationApprovedEvent,
...
export function handleAccessGranted(event: AccessGrantedEvent): void {
  ...
  entity.accessToken = event.params.accessToken
...
export function handleCertificateMinted(event: CertificateMintedEvent): void {
  ...
  entity.tokenId = event.params.tokenId
  entity.owner = event.params.owner
  entity.certId = event.params.certId
...
export function handleCertificationApproved(
  event: CertificationApprovedEvent
): void {
  let entity = new CertificationApproved(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
